...
class AddBookWindow(Ui_Form, QWidget):
    ...
    def add(self):
        ...
        if '' in [book_name, author, publish_company, publish_date, store_num, ISBN_Code, Book_Classification]:
        ...
        if count:
            ...
            return
        book_info = [get_uuid(), book_name, author, publish_company, ISBN_Code, Book_Classification, store_num, 0, get_current_time(), publish_date]
